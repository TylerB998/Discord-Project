...
export default {
    ...
    callback: ({ }) => {
        ...
        '\nAssistant commands:' +
        '\n-------------------------------------------------------------------' +
        '\n!schedule: This command can be used so that I can remind you of important daily tasks. These tasks can range from, reminding you when to eat, when to drink water, when to take care of your pets, or even when you should be getting ready for sleep.' +
        '\n' +
        '\n[NOTE!] You may schedule these reminders at any time by typing in !schedule(your channel you want your reminder to be put into - #reminder_channel)(The date [YYYY/MM/DD] - 2022/8/21)(A time [HH:MM AM or PM] - 10:30 AM)(TimeZone - America/Seattle)' +
